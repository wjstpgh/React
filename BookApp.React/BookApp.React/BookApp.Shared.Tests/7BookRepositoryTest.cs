...
{
    /// <summary>
    /// [7]Test Class: (Arrange -> Act -> Asset) Pattern
    ...
    public class BookRepositoryTest
    {
        ...
        {
            #region [0] DbContextOptions<Task> Object Creation and ILoggerFactory Object Creation
            //[0] DbContextOptions<Task> Object Creation and ILoggerFactory Object Creation
            var options = new DbContextOptionsBuilder<BookAppDbContext>()
                .UseInMemoryDatabase(databaseName: $"BookApp{Guid.NewGuid()}").Options;
            //.UseSqlServer("server = (localdb)\\mssqllocaldb;InMemoryDatabaseFacadeExtensions = BookApp;integrated security = true;").Options;
